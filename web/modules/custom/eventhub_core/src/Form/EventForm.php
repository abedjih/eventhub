  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('eventhub_core')->notice('New event %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The event %label has been updated.', $message_args));
        $this->logger('eventhub_core')->notice('The event %label has been updated.', $logger_args);
        break;

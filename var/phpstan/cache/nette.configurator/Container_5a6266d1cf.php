...
class Container_5a6266d1cf extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_5a6266d1cf $container)
			{
	...
	public function createServiceContainer(): Container_5a6266d1cf
	{
		return $this;
	}

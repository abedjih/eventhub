...
class Container_15a825b76f extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_15a825b76f $container)
			{
	...
	public function createServiceContainer(): Container_15a825b76f
	{
		return $this;
	}

...
class Container_3bbc234a2e extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_3bbc234a2e $container)
			{
	...
	public function createServiceContainer(): Container_3bbc234a2e
	{
		return $this;
	}

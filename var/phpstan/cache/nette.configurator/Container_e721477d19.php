...
class Container_e721477d19 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e721477d19 $container)
			{
	...
	public function createServiceContainer(): Container_e721477d19
	{
		return $this;
	}

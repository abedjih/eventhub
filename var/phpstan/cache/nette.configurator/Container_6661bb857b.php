...
// source: /var/www/html/vendor/phpstan/extension-installer/src/../../../composer/composer/phpstan/rules.neon
// source: /var/www/html/vendor/phpstan/extension-installer/src/../../../composer/pcre/extension.neon
// source: /var/www/html/vendor/phpstan/extension-installer/src/../../../mglaman/phpstan-drupal/extension.neon
// source: /var/www/html/vendor/phpstan/extension-installer/src/../../../mglaman/phpstan-drupal/rules.neon
// source: /var/www/html/vendor/phpstan/extension-installer/src/../../phpstan-deprecation-rules/rules.neon
// source: /var/www/html/vendor/phpstan/extension-installer/src/../../phpstan-phpunit/extension.neon
// source: /var/www/html/vendor/phpstan/extension-installer/src/../../phpstan-phpunit/rules.neon
...
class Container_6661bb857b extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/var/www/html/var/phpstan/resultCache.php');
	}
	...
	public function createService042(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('05'),
			['#Call to an undefined method Drupal\\\.*#', '#Access to an undefined property Drupal\\\.*#'],
			false
		);
	}
	...
	public function createService045(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/var/www/html/vendor/composer/composer/phpstan/rules.neon',
				...
				'/var/www/html/vendor/phpstan/phpstan-phpunit/rules.neon',
	...
	public function createService081(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			[
				...
				'/var/www/html/vendor/phpstan/phpstan-phpunit/stubs/Assert.stub',
				'/var/www/html/vendor/phpstan/phpstan-phpunit/stubs/AssertionFailedError.stub',
				'/var/www/html/vendor/phpstan/phpstan-phpunit/stubs/ExpectationFailedException.stub',
				'/var/www/html/vendor/phpstan/phpstan-phpunit/stubs/MockBuilder.stub',
				'/var/www/html/vendor/phpstan/phpstan-phpunit/stubs/MockObject.stub',
				'/var/www/html/vendor/phpstan/phpstan-phpunit/stubs/Stub.stub',
				'/var/www/html/vendor/phpstan/phpstan-phpunit/stubs/TestCase.stub',
			],
			['/var/www/html']
		);
	}
	...
	{
		return new PHPStan\Rules\RuleLevelHelper($this->getService('reflectionProvider'), false, false, false, true, true, false, true);
	}
	...
	public function createService0347(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/var/www/html',
			'/var/www/html/var/phpstan',
			[
				'phar:///var/www/html/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'/var/www/html/vendor/phpstan/extension-installer/src/../../../composer/composer/phpstan/rules.neon',
				'/var/www/html/vendor/phpstan/extension-installer/src/../../../composer/pcre/extension.neon',
				'/var/www/html/vendor/phpstan/extension-installer/src/../../../mglaman/phpstan-drupal/extension.neon',
				'/var/www/html/vendor/phpstan/extension-installer/src/../../../mglaman/phpstan-drupal/rules.neon',
				'/var/www/html/vendor/phpstan/extension-installer/src/../../phpstan-deprecation-rules/rules.neon',
				'/var/www/html/vendor/phpstan/extension-installer/src/../../phpstan-phpunit/extension.neon',
				'/var/www/html/vendor/phpstan/extension-installer/src/../../phpstan-phpunit/rules.neon',
				'/var/www/html/phpstan.neon',
			],
			$this->getParameter('analysedPaths'),
			['/var/www/html'],
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_6661bb857b $container)
			{
		...
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/var/www/html/var/phpstan/resultCache.php',
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/var/www/html/var/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_6661bb857b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 6,
			'paths' => ['/var/www/html/web/modules/custom'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'ignoreErrors' => ['#Call to an undefined method Drupal\\\.*#', '#Access to an undefined property Drupal\\\.*#'],
			...
			'resultCachePath' => '/var/www/html/var/phpstan/resultCache.php',
			...
			'tmpDir' => '/var/www/html/var/phpstan',
			'checkMissingIterableValueType' => true,
			'checkGenericClassInNonGenericObjectType' => true,
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/var/www/html/var/phpstan',
			...
			'env' => [
				...
				'HOSTNAME' => 'eventhub-web',
				'MH_SMTP_BIND_ADDR' => '127.0.0.1:1025',
				'DDEV_PRIMARY_URL_WITHOUT_PORT' => 'https://eventhub.ddev.site',
				'DDEV_GID' => '1000',
				...
				'HTTPS_EXPOSE' => '8002:80,8026:8025',
				'COREPACK_HOME' => '/mnt/ddev-global-cache/corepack',
				'DDEV_PRIMARY_URL' => 'https://eventhub.ddev.site:8002',
				'LINES' => '30',
				'DDEV_SITENAME' => 'eventhub',
				'HOME' => '/home/ben',
				'DRUSH_OPTIONS_URI' => 'https://eventhub.ddev.site:8002',
				'LANG' => 'C.UTF-8',
				'PHP_IDE_CONFIG' => 'serverName=eventhub.ddev.site',
				'COLUMNS' => '120',
				'DDEV_MUTAGEN_ENABLED' => 'false',
				'DDEV_USER' => 'ben',
				'PGUSER' => 'db',
				'TERMINUS_CACHE_DIR' => '/mnt/ddev-global-cache/terminus/cache',
				'DDEV_PRIMARY_URL_PORT' => '8002',
				'DDEV_ROUTER_HTTP_PORT' => '8001',
				'COMPOSER_PROCESS_TIMEOUT' => '2000',
				'NGINX_SITE_TEMPLATE' => '/etc/nginx/nginx-site.conf',
				'DDEV_FILES_DIRS' => '/var/www/html/web/sites/default/files',
				'HTTP_EXPOSE' => '8001:80,8025:8025',
				'NVM_DIR' => '/home/ben/.nvm',
				'DDEV_PHP_VERSION' => '8.3',
				'DDEV_TLD' => 'ddev.site',
				'DDEV_HOSTNAME' => 'eventhub.ddev.site',
				'DDEV_PROJECT' => 'eventhub',
				'DDEV_GOARCH' => 'amd64',
				'VIRTUAL_HOST' => 'eventhub.ddev.site',
				'TERM' => 'xterm',
				'USER' => 'ben',
				'MYSQL_HISTFILE' => '/mnt/ddev-global-cache/mysqlhistory/eventhub-web/mysql_history',
				...
				'PATH' => '/home/ben/bin:/var/www/html/vendor/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/var/www/html/bin:/mnt/ddev-global-cache/global-commands/web',
				'HOST_DOCKER_INTERNAL_IP' => '',
				'DEBIAN_FRONTEND' => 'noninteractive',
				'DDEV_PROJECT_TYPE' => 'drupal11',
				'DDEV_ROUTER_HTTPS_PORT' => '8002',

...
class Container_d370559645 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService042(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				['identifier' => 'new.static', 'path' => '/var/www/html/web/modules/custom/*'],
				...
				[
					...
					'paths' => ['/var/www/html/web/modules/custom/*.install', '/var/www/html/web/modules/custom/*.module'],
				],
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d370559645 $container)
			{
	...
	public function createServiceContainer(): Container_d370559645
	{
		return $this;
	}

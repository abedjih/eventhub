...
class Container_a7b41c0bc9 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a7b41c0bc9 $container)
			{
	...
	public function createServiceContainer(): Container_a7b41c0bc9
	{
		return $this;
	}
